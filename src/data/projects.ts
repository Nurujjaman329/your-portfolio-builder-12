...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    storeLink: false,
    overview:
      "MyKrishi is a smart agriculture investment platform built for Synergy Interface Ltd. Investors discover trending farm projects from a real-time homepage, browse and book investments, manage their cart and checkout flow, track running and matured farms with profit disbursements, and communicate with field agents for project updates — with flexible online, bank and office payment options.",
    challenge:
      "Building an end-to-end investment journey — from project discovery and multi-project cart checkout to booking summaries, profile and bank verification, and three payment channels — while keeping investors informed with real-time project alerts and agent communication in the field.",
    solution:
      "Delivered an investor-centric dashboard with trending projects and status alerts on the homepage. Investors browse all projects, manage booked farms with status filters, use cart-based checkout for single or multiple investments, and view booking summaries covering running farms, matured farms and profit disbursements. Profile, bank details and password management sit in settings; payments support online gateway, bank and office options with agent chat for field activity updates.",
    architecture: {
      pattern: "Clean Architecture (MVVM-inspired)",
      description:
        "Project discovery, cart/checkout, booking management and payments are isolated features sharing investment and user domain entities. Payment gateway integration lives in the data layer with server-confirmed transactions.",
      layers: [
        { name: "Presentation", desc: "Investor homepage, project lists, cart, booking summary, settings, profile and payment screens." },
        { name: "Domain", desc: "Project, Booking, Cart, Investment and Agent entities with payment and status use cases." },
        { name: "Data", desc: "REST API client, payment gateway SDK, agent messaging and session cache." },
      ],
    },
    stateManagement: {
      solution: "Provider + ChangeNotifier",
      reason:
        "Investment flows are read-heavy with periodic status updates. Provider kept cart, booking list and profile state lightweight without unnecessary Bloc boilerplate.",
    },
    stack: [
      { name: "Flutter", purpose: "Cross-platform investment app for agriculture projects" },
      { name: "ShurjoPay", purpose: "Online payment gateway for investment checkout" },
      { name: "REST API", purpose: "Projects, bookings, cart, profile and profit disbursements" },
      { name: "Real-time Alerts", purpose: "Project status, opportunities and announcement notifications" },
    ],
    highlights: [
      { title: "Login", desc: "Investors authenticate with email and password to access their dashboard." },
      { title: "Homepage Dashboard", desc: "View recent and trending projects with real-time alerts on status, opportunities and announcements." },
      { title: "Projects List", desc: "Browse the complete list of all available agriculture investment projects." },
      { title: "My Projects", desc: "View booked projects and filter by investment status." },
      { title: "Cart List", desc: "Manage cart items, remove projects and proceed to checkout for one or multiple investments." },
      { title: "Booking Summary", desc: "Overview of running farms, matured farms and profit disbursements in one place." },
      { title: "Settings", desc: "Access profile, bank details, terms and conditions, and logout." },
      { title: "Reset Password", desc: "Securely update account password to maintain access safety." },
      { title: "Complete Profile", desc: "Update personal information required for investment onboarding." },
      { title: "Bank Details", desc: "Manage bank account details for seamless transactions and accurate payout records." },
      { title: "Payment Selection", desc: "Choose from three payment options — Online, Bank or Office." },
      { title: "Online Payment", desc: "Process online investments securely through the integrated payment gateway." },
      { title: "Field Activity", desc: "Communicate with agents to receive project updates and discuss field-related activities." },
    ],
    images: [
      "/projects/mykrishi/login.png",
      "/projects/mykrishi/homepage.png",
      "/projects/mykrishi/projects.png",
      "/projects/mykrishi/my-projects.png",
      "/projects/mykrishi/cart-list.png",
      "/projects/mykrishi/booking-summary.png",
      "/projects/mykrishi/settings.png",
      "/projects/mykrishi/reset-password.png",
      "/projects/mykrishi/complete-profile.png",
      "/projects/mykrishi/bank-details.png",
      "/projects/mykrishi/payment-selection.png",
      "/projects/mykrishi/online-payment.png",
      "/projects/mykrishi/field-activity.png",
    ],
    results: [
      "Deployed to production for Synergy Interface Ltd. client.",
      "End-to-end investor journey from discovery to payment and booking tracking.",
      "Online, bank and office payment channels processing investment transactions.",
    ],
  },
  {
