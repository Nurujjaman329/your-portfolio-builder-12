...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Alex Carter, a senior full-stack engineer building scalable web platforms with React, TypeScript and Node." },
      { name: "author", content: "Alex Carter" },
      { property: "og:title", content: "Alex Carter — Senior Software Engineer" },
      { property: "og:description", content: "Senior full-stack engineer. React · TypeScript · Node · Cloud." },
